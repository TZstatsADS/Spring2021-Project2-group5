...
ui <- fluidPage(
    ...
    navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
               title= img(src="4newyorker_long.png", style="vertical-align= top", height = "180%"),
                        ...
                        fluidRow(
                            ...
                            absolutePanel(id = "foreground", class = "foreground-content",
                                          ...
                                          fluidRow(style = "padding: 7.5%; background-color: white; text-align: center",
                                            tags$h1("COVID-19", style="font-weight:bold"),
                                            tags$h2("WE ARE IN THIS TOGETHER", style="font-weight:bold"),tags$br(),
                                            tags$h3("Welcome to our site!", style="color:#18bc9c; font-weight:bold"),
                                            tags$h4("We would like to be your source for Coronavirus updates, resources, and trends in New York City.", style="color:#18bc9c"),tags$br(),
                                            tags$p("The work done so far includes a live update on Covid-19 cases in NYC, an interactive map tool to find Covid-19 related resources, and some mobility trend analysis result. We will keep adding more supporting features...", style="font-weight:italic")
                                            ),
                                          style = "opacity: 0.95")
                            )
                        ),
               ...
               tabPanel('About', icon = icon("info"),
                        ...
                        tags$b("Mobility Data: "), tags$a(href="https://www.google.com/covid19/mobility/", "Google's COVID-19 Community Mobility Reports"),tags$br(),
